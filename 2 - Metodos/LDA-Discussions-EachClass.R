...
dir.create(file.path(getwd(), "../../Results/LDATeste/"))
...
registerDoMC(4)
tableTermosLDADiscussion = foreach( i=c(1:nrow(MessagesVocabulary)), .combine="rbind") %dopar% {
...
write.csv(tableTermosLDADiscussion, file="../../Results/LDATeste/LDAGibbs Each Discussion.csv", row.names = F)
